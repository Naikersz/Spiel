...
"""
# Diese main macht nur das Inventar-Management.

 Verfügbare Helden:
1. Bla

➡️ Welchen Helden willst du laden? (Nummer): 1
✅ Held 'Bla' erfolgreich geladen.

🧙 Held 'Bla' erfolgreich geladen!


=== 🧭 INVENTAR-MANAGER ===
1️⃣  Ausrüstung ins globale Inventar verschieben
2️⃣  Gegenstand aus globalem Inventar anlegen
3️⃣  Globales Inventar anzeigen
4️⃣  Spiel beenden
